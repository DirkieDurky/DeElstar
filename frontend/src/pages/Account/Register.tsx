    ...
    const handleSubmit = async (e: any) => {
        ...
        await axios.post(`${process.env.REACT_APP_URL}/api/register`, {
            ...
            switch (res.data.status) {
                ...
                default: {
                    globalErr = `Er ging iets mis vanuit onze kant. Sorry! Probeer het (later) opnieuw. (Error code ${res.data.status})`;
                    break;
                }
            }

        }).catch((res) => {
            globalErr = `Er ging iets mis vanuit onze kant. Sorry! Probeer het later opnieuw. (${res})`;
        });
